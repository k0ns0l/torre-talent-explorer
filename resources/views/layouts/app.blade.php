...
<body class="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen font-inter flex flex-col">
    <!-- Navigation -->
    <nav class="bg-white/80 backdrop-blur-md shadow-lg border-b border-white/20 sticky top-0 z-50">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-4 lg:space-x-8">
                    ...
                    <a href="{{ route('register') }}" class="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 sm:px-6 py-2 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl text-sm sm:text-base">
                        Get Started
                    </a>
                    @endauth
                </div>
                ...
                <div class="flex md:hidden items-center">
                    <button id="mobile-menu-button" aria-label="Toggle menu" class="text-gray-700 hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50 rounded-md p-1">
        ...
        <!-- Mobile Navigation -->
        <div id="mobile-menu" class="hidden md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-lg transform transition-all duration-300">
            <div class="px-4 pt-2 pb-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="w-full text-left px-3 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 rounded-md transition-all duration-200">
                        <span class="flex items-center space-x-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                            </svg>
                ...
                <div class="space-y-2 pt-2">
                    <a href="{{ route('login') }}" class="block px-3 py-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-all duration-200">
                        Login
                    </a>
                    <a href="{{ route('register') }}" class="block mx-3 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-md text-center hover:from-blue-700 hover:to-purple-700 transition-all duration-200">
                        Get Started
                    </a>
                </div>
                @endauth
    ...
    <main class="flex-grow container mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 bg-red-50 border-l-4 border-red-400 p-4 rounded-r-lg shadow-sm animate-fade-in">
            <div class="flex items-center">
                ...
                <button class="ml-auto text-red-400 hover:text-red-500" onclick="this.parentElement.parentElement.remove()">
        ...
        <div class="mb-6 bg-green-50 border-l-4 border-green-400 p-4 rounded-r-lg shadow-sm animate-fade-in">
            <div class="flex items-center">
                ...
                <button class="ml-auto text-green-400 hover:text-green-500" onclick="this.parentElement.parentElement.remove()">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                    </svg>
                </button>
